...
d3.json "data.json", (data) ->
    mychart = cichart({height:height, width:width, margin:margin, axispos:axispos, xcatlabels:["A","B","C"]})
    mychart(d3.select("div#chart1"), data)

# Example 2: horizontal
d3.json "data.json", (data) ->
    mychart = cichart({height:width, width:height, margin:margin, axispos:axispos, horizontal:true, xcatlabels:["A","B","C"]})
...
d3.json "data.json", (data) ->
    ...
    mychart = cichart({height:height, width:width, margin:margin, axispos:axispos, xcatlabels:["A","B","C","D"]})
