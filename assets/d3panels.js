...
d3panels.calc_chrscales = function(plot_width, left_margin, gap, chr, start, end, reverse) {
  ...
  for (i in chr) {
    ...
    xscale[chr[i]] = d3.scale.linear().domain(domain).range(range);
  }
  return xscale;
};
...
d3panels.pad_vector = function(x, pad) {
  if (pad == null) {
    pad = null;
  }
  if (pad == null) {
...
d3panels.missing2null = function(vec, missingvalues) {
...
d3panels.displayError = function(message, divid) {
  var div;
  if (divid == null) {
    divid = null;
  }
...
d3panels.ci_by_group = function(g, y, m) {
...
d3panels.pad_ylim = function(ylim, p) {
  var d;
  if (p == null) {
    p = 0.025;
  }
...
d3panels.lod2dheatmap = function(chartOpts) {
  var cellSelect, celltip, chart, chrGap, colors, equalCells, height, hilitcolor, margin, nullcolor, oneAtTop, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, width, xscale, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
    chartOpts = {};
  }
  width = (ref = chartOpts != null ? chartOpts.width : void 0) != null ? ref : 800;
  height = (ref1 = chartOpts != null ? chartOpts.height : void 0) != null ? ref1 : 800;
  ...
  chrGap = (ref3 = chartOpts != null ? chartOpts.chrGap : void 0) != null ? ref3 : 6;
  equalCells = (ref4 = chartOpts != null ? chartOpts.equalCells : void 0) != null ? ref4 : false;
  oneAtTop = (ref5 = chartOpts != null ? chartOpts.oneAtTop : void 0) != null ? ref5 : false;
  colors = (ref6 = chartOpts != null ? chartOpts.colors : void 0) != null ? ref6 : ["slateblue", "white", "crimson"];
  nullcolor = (ref7 = chartOpts != null ? chartOpts.nullcolor : void 0) != null ? ref7 : "#e6e6e6";
  ...
  hilitcolor = (ref10 = chartOpts != null ? chartOpts.hilitcolor : void 0) != null ? ref10 : "black";
  ...
  chart = function(selection, data) {
    var c, cellg, cells, chr, i, indexWithinChr, j, k, l, len, len1, len2, len3, len4, m, myframe, n, n_pos, o, posByChr, ref12, ref13, ref14, ref15, ref16, these_pos, x, xmid_scaled, y, ymid_scaled, zmax, zmin;
...
d3panels.chrpanelframe = function(chartOpts) {
  ...
  chrlinecolor = (ref15 = chartOpts != null ? chartOpts.chrlinecolor : void 0) != null ? ref15 : "";
  chrlinewidth = (ref16 = chartOpts != null ? chartOpts.chrlinewidth : void 0) != null ? ref16 : 2;
  boxcolor = (ref17 = chartOpts != null ? chartOpts.boxcolor : void 0) != null ? ref17 : "black";
  boxwidth = (ref18 = chartOpts != null ? chartOpts.boxwidth : void 0) != null ? ref18 : 2;
  ylineOpts = (ref19 = chartOpts != null ? chartOpts.ylineOpts : void 0) != null ? ref19 : {
    color: "white",
    width: 2
  };
  chrGap = (ref20 = chartOpts != null ? chartOpts.chrGap : void 0) != null ? ref20 : 6;
  horizontal = (ref21 = chartOpts.horizontal) != null ? ref21 : false;
  xscale = null;
  yscale = null;
  xlabels = null;
  ylabels = null;
...
d3panels.chr2dpanelframe = function(chartOpts) {
  ...
  title = (ref5 = chartOpts != null ? chartOpts.title : void 0) != null ? ref5 : "";
  xlab = (ref6 = chartOpts != null ? chartOpts.xlab : void 0) != null ? ref6 : "Chromosome";
  ylab = (ref7 = chartOpts != null ? chartOpts.ylab : void 0) != null ? ref7 : "Chromosome";
  rotate_ylab = (ref8 = chartOpts != null ? chartOpts.rotate_ylab : void 0) != null ? ref8 : null;
...
d3panels.curvechart = function(chartOpts) {
  ...
  xlim = (ref = chartOpts != null ? chartOpts.xlim : void 0) != null ? ref : null;
  ylim = (ref1 = chartOpts != null ? chartOpts.ylim : void 0) != null ? ref1 : null;
  linecolor = (ref2 = chartOpts != null ? chartOpts.linecolor : void 0) != null ? ref2 : null;
  linecolorhilit = (ref3 = chartOpts != null ? chartOpts.linecolorhilit : void 0) != null ? ref3 : null;
  linewidth = (ref4 = chartOpts != null ? chartOpts.linewidth : void 0) != null ? ref4 : 2;
  linewidthhilit = (ref5 = chartOpts != null ? chartOpts.linewidthhilit : void 0) != null ? ref5 : 2;
  ...
  chart = function(selection, data) {
    ...
    if (jitter === "random") {
      ...
      for (i in scaledPoints) {
        ...
        for (j in scaledPoints) {
          if (j !== i) {
            q = scaledPoints[j];
            if (horizontal) {
              if (p.y === q.y && Math.abs(p.x - q.x) < pointsize * 2) {
                nearbyPoints[i].push(j);
              }
            } else {
              if (p.x === q.x && Math.abs(p.y - q.y) < pointsize * 2) {
                nearbyPoints[i].push(j);
              }
            }
          }
          ...
          if (d < pointsize * 2) {
            if (horizontal) {
              ...
              if (dx < 0) {
                ...
                results1.push(q.x += (pointsize * 2 - d) * alpha);
              } else {
                p.x += (pointsize * 2 - d) * alpha;
                results1.push(q.x -= (pointsize * 2 - d) * alpha);
              }
      ...
      tick = function(e) {
        ...
        if (horizontal) {
          return points.attr("cy", function(d) {
            return d.y;
          });
        } else {
...
d3panels.heatmap = function(chartOpts) {
  var cellSelect, celltip, chart, colors, hilitcolor, margin, nullcolor, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, svg, tipclass, xlim, xscale, ylim, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
    chartOpts = {};
  }
  ...
  hilitcolor = (ref7 = chartOpts != null ? chartOpts.hilitcolor : void 0) != null ? ref7 : "black";
  tipclass = (ref8 = chartOpts != null ? chartOpts.tipclass : void 0) != null ? ref8 : "tooltip";
  xscale = null;
  yscale = null;
  zscale = null;
  cellSelect = null;
  ...
  svg = null;
  chart = function(selection, data) {
    var cell, cellrect, cells, i, j, myframe, nx, ny, ref10, ref9, xlabels, xmid, xmid_scaled, xv, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
    if (data.xcat != null) {
      data.x = (function() {
        var results;
        results = [];
...
d3panels.add_curves = function(chartOpts) {
  var chart, curveGroup, curves, indtip, linecolor, linecolorhilit, linewidth, linewidthhilit, pointGroup, ref, ref1, ref2, ref3, ref4, tipclass;
  if (chartOpts == null) {
    chartOpts = {};
  }
  linecolor = (ref = chartOpts != null ? chartOpts.linecolor : void 0) != null ? ref : null;
  linecolorhilit = (ref1 = chartOpts != null ? chartOpts.linecolorhilit : void 0) != null ? ref1 : null;
  linewidth = (ref2 = chartOpts != null ? chartOpts.linewidth : void 0) != null ? ref2 : 2;
  linewidthhilit = (ref3 = chartOpts != null ? chartOpts.linewidthhilit : void 0) != null ? ref3 : 2;
  tipclass = (ref4 = chartOpts != null ? chartOpts.tipclass : void 0) != null ? ref4 : "tooltip";
  curves = null;
  indtip = null;
  curveGroup = null;
  pointGroup = null;
  chart = function(prevchart, data) {
    ...
    svg.call(indtip);
    curvefunc = d3.svg.line().x(function(d) {
      return xscale(d.x);
    }).y(function(d) {
      return yscale(d.y);
    });
    ...
    curves = curveGroup.selectAll("empty").data(d3.range(n_ind)).enter().append("path").datum(function(d) {
      ...
      var circle;
      d3.select(this).attr("stroke", linecolorhilit[group[i]]).attr("stroke-width", linewidthhilit).moveToFront();
    ...
    for (i in dataByPoint) {
      ref8 = dataByPoint[i];
      for (m = 0, len = ref8.length; m < len; m++) {
        v = ref8[m];
...
d3panels.add_points = function(chartOpts) {
  ...
  pointcolor = (ref = chartOpts != null ? chartOpts.pointcolor : void 0) != null ? ref : null;
  pointstroke = (ref1 = chartOpts != null ? chartOpts.pointstroke : void 0) != null ? ref1 : "black";
  pointsize = (ref2 = chartOpts != null ? chartOpts.pointsize : void 0) != null ? ref2 : 3;
  jitter = (ref3 = chartOpts != null ? chartOpts.jitter : void 0) != null ? ref3 : "beeswarm";
  tipclass = (ref4 = chartOpts != null ? chartOpts.tipclass : void 0) != null ? ref4 : "tooltip";
  points = null;
  indtip = null;
  pointGroup = null;
  chart = function(prevchart, data) {
    ...
    indID = indID != null ? indID : (function() {
      results = [];
      for (var k = 1, ref6 = x.length; 1 <= ref6 ? k <= ref6 : k >= ref6; 1 <= ref6 ? k++ : k--){ results.push(k); }
      return results;
    }).apply(this);
    if (indID.length !== x.length) {
    ...
    if (prevchart.xNA() || prevchart.yNA()) {
      if (jitter === "random") {
        ...
        collision = function(p, alpha) {
          var d, dx, dy, len1, m, ref8, results1;
          ref8 = nearbyPoints[p.index];
          results1 = [];
...
d3panels.lodheatmap = function(chartOpts) {
  var cellSelect, celltip, chart, chrGap, colors, equalCells, height, hilitcolor, horizontal, margin, nullcolor, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, width, xlab, xscale, ylab, ylim, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
    chartOpts = {};
  }
  width = (ref = chartOpts != null ? chartOpts.width : void 0) != null ? ref : 800;
  ...
  hilitcolor = (ref11 = chartOpts != null ? chartOpts.hilitcolor : void 0) != null ? ref11 : "black";
  chrGap = (ref12 = chartOpts != null ? chartOpts.chrGap : void 0) != null ? ref12 : 6;
  equalCells = (ref13 = chartOpts != null ? chartOpts.equalCells : void 0) != null ? ref13 : false;
  tipclass = (ref14 = chartOpts != null ? chartOpts.tipclass : void 0) != null ? ref14 : "tooltip";
  xscale = null;
  yscale = null;
  zscale = null;
  ...
  svg = null;
  chart = function(selection, data) {
    var c, cellg, cells, chr, i, j, k, l, len, len1, len2, len3, len4, len5, len6, lod, m, myframe, n, n_lod, n_pos, o, p, pos, q, ref15, ref16, ref17, ref18, ref19, ref20, ref21, these_pos, x, xmid_scaled, y, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
    if (data.ycat != null) {
      data.y = (function() {
        var results;
        results = [];
    ...
    ymid_scaled = (function() {
      var len3, n, results;
      results = [];
      for (n = 0, len3 = ymid.length; n < len3; n++) {
        y = ymid[n];
    ...
    for (o = 0, len4 = ref19.length; o < len4; o++) {
      chr = ref19[o];
      ref20 = data.posByChr[chr];
      for (i = p = 0, len5 = ref20.length; p < len5; i = ++p) {
        pos = ref20[i];
        ref21 = data.lodByChr[chr][i];
        for (j = q = 0, len6 = ref21.length; q < len6; j = ++q) {
          lod = ref21[j];
...
d3panels.mapchart = function(chartOpts) {
  ...
  linecolorhilit = (ref2 = chartOpts != null ? chartOpts.linecolorhilit : void 0) != null ? ref2 : "Orchid";
