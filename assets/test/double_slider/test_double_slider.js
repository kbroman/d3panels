...
(function () {
  ...
  // slider size
  var callback3a, callback3b, circles, circles2, data, fig, fig2, figh, figw, figw2, h, left_margin, marker_pos, my_slider, my_slider2, my_slider3, mychart3, pointsize, right_margin, slider2_callback1, slider2_callback2, slider2_g, slider3_g, slider_callback1, slider_callback2, slider_g, slider_height, slider_margin, slider_width, svg, svg2, svg3, vpos, w, width, xscale, xscale2;
  ...
  // slider callbacks
  slider_callback1 = function slider_callback1(sl) {
    return circles[0].attr("cx", xscale(sl.value()[0]));
  };

  slider_callback2 = function slider_callback2(sl) {
  ...
  // central horizontal lines
  fig2.selectAll("empty").data(vpos).enter().insert("line").attr("x1", 0).attr("x2", figw2).attr("y1", function (d) {
    return d;
  }).attr("y2", function (d) {
    return d;
  }).attr("stroke", function (d, i) {
  ...
  // slider callbacks
  slider2_callback1 = function slider2_callback1(sl) {
    return circles2[0].attr("cx", xscale2(sl.value()[0]));
  };

  slider2_callback2 = function slider2_callback2(sl) {
    return circles2[1].attr("cx", xscale2(sl.value()[1]));
  };
  ...
  my_slider2(slider2_g, slider2_callback1, slider2_callback2, [d3.min(marker_pos), d3.max(marker_pos)], marker_pos, [65, 30]);
  ...
  my_slider3 = d3panels.double_slider({
    height: 100,
    width: 400
  });

  callback3a = function callback3a(sl) {
    var value;
    value = sl.value();
    return mychart3.points().attr("opacity", value[0]);
  };

  callback3b = function callback3b(sl) {
    var value;
    value = sl.value();
    return mychart3.points().attr("r", value[1] * pointsize);
  };
