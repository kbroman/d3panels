...
(function() {
  ...
  fig.selectAll("empty").data(marker_pos).enter().insert("line").attr("stroke", "black").attr("stroke-width", 2).attr("x1", (d) => {
    return xscale(d);
  }).attr("x2", (d) => {
    return xscale(d);
  ...
  // add vertical lines to figure
  fig2.selectAll("empty").data(marker_pos).enter().insert("line").attr("stroke", "black").attr("stroke-width", 2).attr("x1", (d) => {
    return xscale2(d);
  }).attr("x2", (d) => {
    return xscale2(d);
  }).attr("y1", 0).attr("y2", figh);
  ...
  callback3a = function(sl) {
    var value;
    value = sl.value();
    return mychart3.points().attr("opacity", value[0]);
  };

  callback3b = function(sl) {
    var value;
    value = sl.value();
