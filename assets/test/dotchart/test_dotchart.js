...
(function () {
  ...
  d3.json("data.json").then(function (data) {
    ...
    mychart(d3.select("div#chart2"), these_data); // animate points
  ...
  mychart3(d3.select("div#chart3"), these_data); // animate points
  ...
  mychart4(d3.select("div#chart4"), these_data); // animate points
