...
panelframe = function(chartOpts) {
  ...
  svg = null;
  chart = function(selection) {
    var boxes, d, g, i, inner_height, inner_width, plot_height, plot_width, results, xNA_xpos, xaxis, xrange, yNA_ypos, yaxis, ylabpos_x, ylabpos_y, yrange;
...
lodpanelframe = function(chartOpts) {
  var altrectcolor, axispos, boxcolor, boxwidth, chart, chrRect, gap, height, margin, nyticks, rectcolor, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, rotate_ylab, svg, title, titlepos, width, xlab, xscale, ylab, ylabels, ylim, ylineOpts, ylines, yscale, yticklab, yticks;
  width = (ref = chartOpts != null ? chartOpts.width : void 0) != null ? ref : 800;
  height = (ref1 = chartOpts != null ? chartOpts.height : void 0) != null ? ref1 : 500;
  margin = (ref2 = chartOpts != null ? chartOpts.margin : void 0) != null ? ref2 : {
    left: 60,
  ...
  chart = function(selection, data) {
    ...
    chr_length = (function() {
      ...
      results = [];
      for (i in data.end) {
        results.push(data.end[i] - data.start[i]);
      }
      return results;
    })();
    ...
    for (i = j = 1, ref19 = data.chr.length - 1; 1 <= ref19 ? j <= ref19 : j >= ref19; i = 1 <= ref19 ? ++j : --j) {
    ...
    chrRect = g.append("g").selectAll("empty").data(data.chr).enter().append("rect").attr("x", function(d, i) {
      return chr_start_pixels[i] - gap / 2;
    }).attr("width", function(d, i) {
      return chr_length[i] / tot_chr_length * tot_pixels + gap;
    ...
    xscale = {};
    for (i in data.chr) {
      xscale[data.chr[i]] = d3.scale.linear().domain([data.start[i], data.end[i]]).range([chr_start_pixels[i], chr_end_pixels[i]]);
    }
    yticks = yticks != null ? yticks : yscale.ticks(nyticks);
    if ((yticklab != null) && yticklab.length !== yticks.length) {
      displayError("yticklab.length (" + yticklab.length + ") != yticks.length (" + yticks.length + ")");
    ...
    if (!((yticklab != null) && yticklab.length === yticks.length)) {
      yticklab = (function() {
        var k, len, results;
        results = [];
        for (k = 0, len = yticks.length; k < len; k++) {
          d = yticks[k];
          results.push(formatAxis(yticks)(d));
        }
        return results;
    ...
    xlabels = xaxis.append("g").attr("id", "xlabels").selectAll("empty").data(data.chr).enter().append("text").attr("x", function(d, i) {
      return (chr_start_pixels[i] + chr_end_pixels[i]) / 2;
    }).attr("y", height - margin.bottom + axispos.xlabel).text(function(d) {
      return d;
    });
    ylabels = yaxis.append("g").attr("id", "ylabels").selectAll("empty").data(yticklab).enter().append("text").attr("y", function(d, i) {
...
crosstab = function() {
  ...
  chart = function(selection) {
    return selection.each(function(data) {
      ...
      data.xlabel = (ref = data != null ? data.xlabel : void 0) != null ? ref : "";
      data.ylabel = (ref1 = data != null ? data.ylabel : void 0) != null ? ref1 : "";
      cells = [];
      for (i = k = 0, ref2 = nrow; 0 <= ref2 ? k <= ref2 : k >= ref2; i = 0 <= ref2 ? ++k : --k) {
        for (j = l = 0, ref3 = ncol; 0 <= ref3 ? l <= ref3 : l >= ref3; j = 0 <= ref3 ? ++l : --l) {
          cell = {
            value: tab[i][j],
            row: i,
            col: j,
      ...
      xscale = d3.scale.ordinal().domain((function() {
        results = [];
        for (var m = 0, ref4 = ncol + 1; 0 <= ref4 ? m <= ref4 : m >= ref4; 0 <= ref4 ? m++ : m--){ results.push(m); }
        return results;
      }).apply(this)).rangeBands([margin.left, width - margin.right], 0, 0);
      yscale = d3.scale.ordinal().domain((function() {
        results1 = [];
        for (var o = 0, ref5 = nrow + 1; 0 <= ref5 ? o <= ref5 : o >= ref5; 0 <= ref5 ? o++ : o--){ results1.push(o); }
        return results1;
...
lodchart = function() {
  ...
  chart = function(selection) {
    return selection.each(function(data) {
      ...
      margin.inner = (ref = margin != null ? margin.inner : void 0) != null ? ref : 0;
    ...
    return selection.each(function(data) {
      ...
      if (sumArray((function() {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          chr = ref[i];
          results.push(!(data.map[chr] != null));
        }
        return results;
      })()) > 0) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        pos = (function() {
          ...
          for (marker in data.map[chr]) {
            results.push(data.map[chr][marker]);
          }
          return results;
        })();
      ...
      ymin = (function() {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          chr = ref1[j];
          results.push(yextentByChr[chr][0]);
        }
        return results;
      })();
      ymax = (function() {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          chr = ref1[j];
          results.push(yextentByChr[chr][1]);
        }
        return results;
      })();
