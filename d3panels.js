...
var abs, calc_2dchrcell_rect, calc_cell_rect, calc_chrcell_rect, calc_chrscales, calc_crosstab, calc_midpoints, ci_by_group, colSums, count_groups, d3panels, displayError, expand2vector, forceAsArray, formatAxis, getLeftRight, log10, log2, matrixExtent, matrixMax, matrixMaxAbs, matrixMin, maxdiff, mean_by_group, median, missing2null, pad_vector, pullVarAsArray, reorgByChr, reorgLodData, rowSums, sd_by_group, selectGroupColors, sumArray, transpose, unique;
...
reorgByChr = function(uniquechr, chr, vector) {
...
calc_chrscales = function(plot_width, left_margin, gap, chr, start, end, reverse) {
...
calc_chrcell_rect = function(cells, xmid, ymid) {
  var bottom, cell, k, left, len, results, right, top;
  results = [];
  for (k = 0, len = cells.length; k < len; k++) {
    cell = cells[k];
...
calc_2dchrcell_rect = function(cells, xmid, ymid) {
  var bottom, cell, k, left, len, results, right, top;
  results = [];
  for (k = 0, len = cells.length; k < len; k++) {
    cell = cells[k];
...
lod2dheatmap = function(chartOpts) {
  var cellSelect, celltip, chart, chrGap, colors, hilitcolor, nullcolor, oneAtTop, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, svg, tipclass, xscale, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
    chartOpts = {};
  }
  chrGap = (ref = chartOpts != null ? chartOpts.chrGap : void 0) != null ? ref : 6;
  oneAtTop = (ref1 = chartOpts != null ? chartOpts.oneAtTop : void 0) != null ? ref1 : false;
  colors = (ref2 = chartOpts != null ? chartOpts.colors : void 0) != null ? ref2 : ["slateblue", "white", "crimson"];
  nullcolor = (ref3 = chartOpts != null ? chartOpts.nullcolor : void 0) != null ? ref3 : "#e6e6e6";
  zlim = (ref4 = chartOpts != null ? chartOpts.zlim : void 0) != null ? ref4 : null;
  zthresh = (ref5 = chartOpts != null ? chartOpts.zthresh : void 0) != null ? ref5 : null;
  hilitcolor = (ref6 = chartOpts != null ? chartOpts.hilitcolor : void 0) != null ? ref6 : "black";
  ...
  chart = function(selection, data) {
    var c, cellg, cells, chr, i, indexWithinChr, j, k, l, len, len1, len2, len3, m, myframe, n, n_pos, posByChr, ref10, ref11, ref8, ref9, these_pos, x, xmid_scaled, y, ymid_scaled, zmax, zmin;
    ...
    for (m = 0, len2 = ref10.length; m < len2; m++) {
      chr = ref10[m];
      xmid_scaled[chr] = calc_midpoints(pad_vector((function() {
        var len3, n, ref11, results;
        ref11 = posByChr[chr];
        results = [];
      ...
      ymid_scaled[chr] = calc_midpoints(pad_vector((function() {
        var len3, n, ref11, results;
        ref11 = posByChr[chr];
        results = [];
        for (n = 0, len3 = ref11.length; n < len3; n++) {
    ...
    celltip = d3.tip().attr('class', "d3-tip " + tipclass).html(function(d) {
      ...
      return "(" + d.chrx + "@" + px + "," + d.chry + "@" + py + ") &rarr; " + z;
...
chrpanelframe = function(chartOpts) {
...
curvechart = function(chartOpts) {
  var chart, curvesSelect, indtip, ref, ref1, ref2, ref3, ref4, ref5, ref6, strokecolor, strokecolorhilit, strokewidth, strokewidthhilit, svg, tipclass, xlim, xscale, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {};
  }
  xlim = (ref = chartOpts != null ? chartOpts.xlim : void 0) != null ? ref : null;
  ylim = (ref1 = chartOpts != null ? chartOpts.ylim : void 0) != null ? ref1 : null;
  strokecolor = (ref2 = chartOpts != null ? chartOpts.strokecolor : void 0) != null ? ref2 : null;
  ...
  chart = function(selection, data) {
    ...
    xlim = xlim != null ? xlim : matrixExtent(x);
    ylim = ylim != null ? ylim : matrixExtent(y);
    chartOpts.xlim = xlim;
    chartOpts.ylim = ylim;
    for (i in x) {
    ...
    curvesSelect = curves.selectAll("empty").data(d3.range(n_ind)).enter().append("path").datum(function(d) {
    ...
    for (i in dataByPoint) {
      ref10 = dataByPoint[i];
      for (m = 0, len = ref10.length; m < len; m++) {
        v = ref10[m];
...
lodheatmap = function(chartOpts) {
  var cellSelect, celltip, chart, chrGap, colors, hilitcolor, horizontal, nullcolor, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, xlab, xscale, ylab, ylim, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
    chartOpts = {};
  }
  colors = (ref = chartOpts != null ? chartOpts.colors : void 0) != null ? ref : ["slateblue", "white", "crimson"];
  nullcolor = (ref1 = chartOpts != null ? chartOpts.nullcolor : void 0) != null ? ref1 : "#e6e6e6";
  xlab = (ref2 = chartOpts != null ? chartOpts.xlab : void 0) != null ? ref2 : "Chromosome";
  ylab = (ref3 = chartOpts != null ? chartOpts.ylab : void 0) != null ? ref3 : "";
  ylim = (ref4 = chartOpts != null ? chartOpts.ylim : void 0) != null ? ref4 : null;
  zlim = (ref5 = chartOpts != null ? chartOpts.zlim : void 0) != null ? ref5 : null;
  zthresh = (ref6 = chartOpts != null ? chartOpts.zthresh : void 0) != null ? ref6 : null;
  horizontal = (ref7 = chartOpts != null ? chartOpts.horizontal : void 0) != null ? ref7 : false;
  hilitcolor = (ref8 = chartOpts != null ? chartOpts.hilitcolor : void 0) != null ? ref8 : "black";
  chrGap = (ref9 = chartOpts != null ? chartOpts.chrGap : void 0) != null ? ref9 : 6;
  ...
  svg = null;
  chart = function(selection, data) {
    var c, cellg, cells, chr, i, j, k, l, len, len1, len2, len3, len4, len5, lod, m, myframe, n, n_lod, n_pos, o, pos, q, ref11, ref12, ref13, ref14, ref15, ref16, these_pos, x, xmid_scaled, y, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
    if (data.ycat != null) {
      data.y = (function() {
        var results;
        results = [];
    ...
    ymid_scaled = (function() {
      var len2, m, results;
      results = [];
      for (m = 0, len2 = ymid.length; m < len2; m++) {
        y = ymid[m];
    ...
    for (m = 0, len2 = ref13.length; m < len2; m++) {
      chr = ref13[m];
      xmid_scaled[chr] = calc_midpoints(pad_vector((function() {
        var len3, n, ref14, results;
        ref14 = data.posByChr[chr];
        results = [];
    ...
    for (n = 0, len3 = ref14.length; n < len3; n++) {
      chr = ref14[n];
      ref15 = data.posByChr[chr];
      for (i = o = 0, len4 = ref15.length; o < len4; i = ++o) {
        pos = ref15[i];
        ref16 = data.lodByChr[chr][i];
        for (j = q = 0, len5 = ref16.length; q < len5; j = ++q) {
          lod = ref16[j];
    ...
    celltip = d3.tip().attr('class', "d3-tip " + tipclass).html(function(d) {
      ...
      lodlabel = data.ycat != null ? data.ycat[d.lodindex] : formatAxis(data.y)(data.y[d.lodindex]);
      if (horizontal) {
        return lodlabel + ", " + d.chr + "@" + p + " &rarr; " + z;
      }
      return d.chr + "@" + p + ", " + lodlabel + " &rarr; " + z;
    }).direction(function() {
      if (horizontal) {
        return 'n';
      }
