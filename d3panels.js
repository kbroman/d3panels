...
var abs, calc_cell_rect, calc_chrcell_rect, calc_chrscales, calc_crosstab, calc_midpoints, chrscales, ci_by_group, colSums, count_groups, d3panels, displayError, expand2vector, forceAsArray, formatAxis, getLeftRight, log10, log2, matrixExtent, matrixMax, matrixMaxAbs, matrixMin, maxdiff, mean_by_group, median, missing2null, pad_vector, pullVarAsArray, reorgLodData, rowSums, sd_by_group, selectGroupColors, sumArray, transpose, unique;
...
calc_chrscales = function(plot_width, left_margin, gap, chr, start, end, reverse) {
  var chr_end_pixels, chr_length, chr_start_pixels, i, k, n_chr, ref, right, tot_chr_length, tot_pixels, xscale;
  if (reverse == null) {
    reverse = false;
  }
  n_chr = chr.length;
...
heatmap = function(chartOpts) {
  var cellSelect, celltip, chart, colors, margin, nullcolor, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, svg, tipclass, xlim, xscale, ylim, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
    chartOpts = {};
  }
  ...
  svg = null;
  chart = function(selection, data) {
    var cell, cellrect, cells, i, j, myframe, nx, ny, ref8, ref9, xlabels, xmid, xmid_scaled, xv, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
    if (data.xcat != null) {
      data.x = (function() {
        var results;
        results = [];
      ...
      chartOpts.xlab = (ref8 = chartOpts != null ? chartOpts.xlab : void 0) != null ? ref8 : "";
    }
    if (data.ycat != null) {
      data.y = (function() {
        var results;
      ...
      chartOpts.ylab = (ref9 = chartOpts != null ? chartOpts.ylab : void 0) != null ? ref9 : "";
    }
    nx = data.x.length;
    ny = data.y.length;
    if (data.z.length !== nx) {
...
lodheatmap = function(chartOpts) {
  var altrectcolor, cellSelect, celltip, chart, chrGap, colors, horizontal, nullcolor, rectcolor, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, xlab, xscale, ylab, ylim, yscale, zlim, zscale, zthresh;
  colors = (ref = chartOpts != null ? chartOpts.colors : void 0) != null ? ref : ["slateblue", "white", "crimson"];
  rectcolor = (ref1 = chartOpts != null ? chartOpts.rectcolor : void 0) != null ? ref1 : "white";
  altrectcolor = (ref2 = chartOpts != null ? chartOpts.altrectcolor : void 0) != null ? ref2 : "white";
  nullcolor = (ref3 = chartOpts != null ? chartOpts.nullcolor : void 0) != null ? ref3 : "pink";
  xlab = (ref4 = chartOpts != null ? chartOpts.xlab : void 0) != null ? ref4 : "Chromosome";
  ylab = (ref5 = chartOpts != null ? chartOpts.ylab : void 0) != null ? ref5 : "";
  ylim = (ref6 = chartOpts != null ? chartOpts.ylim : void 0) != null ? ref6 : null;
  zlim = (ref7 = chartOpts != null ? chartOpts.zlim : void 0) != null ? ref7 : null;
  zthresh = (ref8 = chartOpts != null ? chartOpts.zthresh : void 0) != null ? ref8 : null;
  horizontal = (ref9 = chartOpts != null ? chartOpts.horizontal : void 0) != null ? ref9 : false;
  chrGap = (ref10 = chartOpts != null ? chartOpts.chrGap : void 0) != null ? ref10 : 6;
  tipclass = (ref11 = chartOpts != null ? chartOpts.tipclass : void 0) != null ? ref11 : "tooltip";
  xscale = null;
  yscale = null;
  zscale = null;
  ...
  svg = null;
  chart = function(selection, data) {
    var c, cellg, cells, chr, i, j, k, l, len, len1, len2, len3, len4, len5, lod, m, myframe, n, n_lod, n_pos, o, pos, q, ref12, ref13, ref14, ref15, ref16, ref17, these_pos, x, xmid_scaled, y, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
    if (data.ycat != null) {
      data.y = (function() {
        var results;
        results = [];
    ...
    for (n = 0, len3 = ref15.length; n < len3; n++) {
      chr = ref15[n];
      ref16 = data.posByChr[chr];
      for (i = o = 0, len4 = ref16.length; o < len4; i = ++o) {
        pos = ref16[i];
        ref17 = data.lodByChr[chr][i];
        for (j = q = 0, len5 = ref17.length; q < len5; j = ++q) {
          lod = ref17[j];
