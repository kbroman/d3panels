...
d3panels.padzeros = function (object) {
  var totlength = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
...
d3panels.formatdate = function (object) {
  return object.getFullYear() + "-" + d3panels.padzeros(object.getMonth() + 1) + "-" + d3panels.padzeros(object.getDate());
};
...
d3panels.formatdatetime = function (object) {
  return d3panels.formattime(object) + " " + d3panels.formatdate(object);
};"use strict";

// Generated by CoffeeScript 2.7.0
// lod2dheatmap: heat map panel, with the two dimensions broken into chromosomes
d3panels.lod2dheatmap = function (chartOpts) {
  var cellSelect, cells, celltip, chart, chrGap, colors, equalCells, height, hilitcolor, margin, nullcolor, oneAtTop, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, tipdirection, width, xscale, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
  ...
  chart = function chart(selection, data) {
    ...
    var cellg, chr, i, indexWithinChr, j, k, l, len, len1, len2, m, myframe, n_pos, posByChr, ref13, ref14, ref15, tooltipfunc, x, xmid_scaled, y, ymid_scaled, zmax, zmin;
    ...
    if (equalCells) {
      data.pos = [];
      ref13 = data.chrname;
      for (k = 0, len = ref13.length; k < len; k++) {
        chr = ref13[k];
...
d3panels.cichart = function (chartOpts) {
  var chart, horizontal, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, segcolor, segments, segstrokewidth, segwidth, svg, tip, tipclass, tipdirection, v_over_h, vertsegcolor, xcatlabels, xlab, xlineOpts, xscale, ylab, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(selection, data) {
    ...
    var high, i, low, mean, myframe, ncat, segmentGroup, tipfunc, xlim, xticks, xval, yval;
...
d3panels.crosstab = function (chartOpts) {
  ...
  chart = function chart(selection, data) {
    ...
    var borders, cell, cellHeight, cellWidth, cells, collab, cols, denom, i, j, k, l, n, ncol, nrow, plot_height, plot_width, rect, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, rowlab, rows, tab, titles, values, xscale, xv, yscale, yv;
...
d3panels.curvechart = function (chartOpts) {
  var chart, curves, indtip, linecolor, linecolorhilit, linewidth, linewidthhilit, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, svg, tipclass, tipdirection, xlim, xscale, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(selection, data) {
    // {x, y, indID, group}
    var add_curves, i, j, myframe, n_ind, ref8, x, y;
    if (data.x == null) {
    ...
    if (x.length === 1 && y.length > 1) {
      ...
      for (j = i = 2, ref8 = n_ind; 2 <= ref8 ? i <= ref8 : i >= ref8; j = 2 <= ref8 ? ++i : --i) {
        x.push(x[0]);
      }
    }
    if (x.length !== n_ind) {
...
d3panels.dotchart = function (chartOpts) {
  var chart, horizontal, indtip, jitter, pointcolor, points, pointsize, pointstroke, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, tipdirection, v_over_h, xNA, xNA_size, xcategories, xcatlabels, xlab, xlineOpts, xscale, yNA, yNA_size, ylab, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(selection, data) {
    ...
    var force, g, group, i, indID, jitter_width, myframe, ngroup, pointGroup, ref18, ref19, ref20, ref21, scaledPoints, u, x, xlim, xv, y;
    ...
    indID = (ref18 = data != null ? data.indID : void 0) != null ? ref18 : function () {
      var results = [];
      for (var j = 1, ref19 = x.length; 1 <= ref19 ? j <= ref19 : j >= ref19; 1 <= ref19 ? j++ : j--) {
        results.push(j);
      }
      return results;
    }.apply(this);
    ...
    // groups of colors
    group = (ref20 = data != null ? data.group : void 0) != null ? ref20 : function () {
      var j, len, results;
      results = [];
    ...
    if (d3panels.sumArray(function () {
      ...
      console.log(x);
      for (i in x) {
        if (x[i] != null && !(ref21 = x[i], indexOf.call(xcategories, ref21) >= 0)) {
          x[i] = null;
        }
      }
    }
...
d3panels.heatmap = function (chartOpts) {
  var cellSelect, cells, celltip, chart, colors, hilitcolor, margin, nullcolor, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, tipdirection, xlim, xscale, ylim, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(selection, data) {
    ...
    var cell, cellrect, i, j, myframe, nx, ny, ref10, ref11, tooltipfunc, xlabels, xmid, xmid_scaled, xv, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
...
d3panels.lodchart = function (chartOpts) {
  var chart, chrSelect, linecolor, linewidth, markerSelect, markertip, pointcolor, pointsize, pointstroke, ref, ref1, ref2, ref3, ref4, ref5, _svg, _xscale, ylim, _yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
...
d3panels.add_lodcurve = function (chartOpts) {
  var chart, g, horizontal, linecolor, linedash, linewidth, markerSelect, markertip, pointcolor, pointsize, pointstroke, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, tipclass, tipdirection;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(prevchart, data) {
    ...
    var bigpointsize, chr, curves, hiddenpoints, i, j, len, lodcurve, markerpoints, ref9, svg, xscale, yscale;
    if (data.chr == null) {
      // data = {chr, pos, lod, marker} each an ordered vector
      //    optionally also chrname, chrstart, chrend with chr IDs, start and end positions
...
d3panels.add_curves = function (chartOpts) {
  var chart, curveGroup, curves, indtip, linecolor, linecolorhilit, linewidth, linewidthhilit, ref, ref1, ref2, ref3, ref4, ref5, tipclass, tipdirection;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(prevchart, data) {
    // prevchart = chart function used to create lodchart to which we're adding
    var curvefunc, dataByPoint, g, group, i, indID, j, k, n_ind, ngroup, ref6, ref7, ref8, svg, x, xscale, y, yscale;
    if (data.x == null) {
    ...
    if (x.length === 1 && y.length > 1) {
      // expand to same length
      for (j = k = 2, ref6 = n_ind; 2 <= ref6 ? k <= ref6 : k >= ref6; j = 2 <= ref6 ? ++k : --k) {
        x.push(x[0]);
      }
    }
    if (x.length !== n_ind) {
    ...
    indID = (ref7 = data != null ? data.indID : void 0) != null ? ref7 : function () {
      var results = [];
    ...
    group = (ref8 = data != null ? data.group : void 0) != null ? ref8 : function () {
      var results;
      results = [];
      for (i in y) {
        results.push(1);
...
d3panels.add_points = function (chartOpts) {
  var chart, indtip, jitter, pointGroup, pointcolor, points, pointsize, pointstroke, ref, ref1, ref2, ref3, ref4, ref5, tipclass, tipdirection;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(prevchart, data) {
    // prevchart = chart function used to create lodchart to which we're adding
    var force, g, group, i, indID, ngroup, ref6, ref7, ref8, scaledPoints, svg, ux, uy, x, xscale, xwid, y, yscale, ywid;
    if (data.x == null) {
      // data = {x, y, indID, group}
    ...
    // grab indID if it's there
    // if no indID, create a vector of them
    indID = (ref6 = data != null ? data.indID : void 0) != null ? ref6 : null;
    indID = indID != null ? indID : function () {
      var results = [];
      for (var j = 1, ref7 = x.length; 1 <= ref7 ? j <= ref7 : j >= ref7; 1 <= ref7 ? j++ : j--) {
        results.push(j);
      }
      return results;
    }.apply(this);
...
d3panels.lodheatmap = function (chartOpts) {
  var cellSelect, cells, celltip, chart, chrGap, colors, equalCells, height, hilitcolor, horizontal, margin, nullcolor, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, tipdirection, width, xlab, xscale, ylab, ylim, yscale, zlim, zscale, zthresh;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(selection, data) {
    ...
    var cellg, celltipfunc, chr, i, j, k, l, len, len1, len2, len3, len4, lod, m, myframe, n, n_lod, n_pos, o, pos, ref16, ref17, ref18, ref19, ref20, x, xmid_scaled, y, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
    ...
    for (m = 0, len2 = ref18.length; m < len2; m++) {
      chr = ref18[m];
      ref19 = data.posByChr[chr];
      for (i = n = 0, len3 = ref19.length; n < len3; i = ++n) {
        pos = ref19[i];
        ref20 = data.lodByChr[chr][i];
        for (j = o = 0, len4 = ref20.length; o < len4; j = ++o) {
          lod = ref20[j];
...
d3panels.mapchart = function (chartOpts) {
  var chart, horizontal, linecolor, linecolorhilit, linewidth, markerSelect, martip, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, shiftStart, svg, tickwidth, tipclass, tipdirection, v_over_h, xlab, xlineOpts, xscale, ylab, yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(selection, data) {
    ...
    var chr, chrscale, extentByChr, i, j, k, l, len, len1, markerpos, markers, minpos, myframe, n_chr, n_pos, pos, ref12, ref13, these_index, these_pos, tipfunc, x, xlim, xticklab, xticks, ylim;
...
d3panels.scatterplot = function (chartOpts) {
  var chart, indtip, jitter, pointcolor, points, pointsize, pointstroke, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, tipdirection, xNA, xNA_size, xlim, xscale, yNA, yNA_size, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
...
d3panels.trichart = function (chartOpts) {
  ...
  chart = function chart(selection, data) {
    // data = {p, indID, group}
    var d, first, flag_length_not_3, flag_out_of_range, flag_sum_not_1, frame, framefunc, g, gr, group, i, indID, indices, j, len, n, ngroup, p, p1, p2, p3, p4, plot_height, plot_width, ref18, ref19, second, sum, v, vertices, vv, xlim, xy, ylim;
    ...
    if (gridlines > 0) {
      ...
      }).attr("stroke", gridcolor).attr("stroke-width", gridwidth).attr("shape-rendering", "crispEdges").style("pointer-events", "none").attr("fill", "none");
...
d3panels.histchart = function (chartOpts) {
  var chart, curves, density, indtip, linecolor, linecolorhilit, linewidth, linewidthhilit, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, rotate_ylab, svg, tipclass, tipdirection, xlab, xlim, xscale, ylab, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
  ...
  chart = function chart(selection, data) {
    // {x, breaks, indID}
    var add_curves, breaks, brlim, d, f, freq, i, j, k, l, len, len1, maxn, maxpos, myframe, n_ind, p, path_data, path_x, path_y, pt, ref12, x, xv, xx;
    if (data.x == null) {
...
d3panels.tooltip_create = function (selection, objects, options, tooltip_func) {
  var direction, fill, fontcolor, fontsize, in_duration, out_duration, pad, ref, ref1, ref2, ref3, ref4, tipclass, tipdiv, tipgroup, triChar, triChar_shift, tridiv;
...
d3panels.timeplot = function (chartOpts) {
  var chart, indtip, jitter, pointcolor, points, pointsize, pointstroke, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, tipdirection, xlim, xscale, yNA, yNA_size, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }

  // chartOpts start
  yNA = (ref = chartOpts != null ? chartOpts.yNA : void 0) != null ? ref : {
    handle: true,
    force: false // handle: include separate boxes for NAs; force: include whether or not NAs in data
  };
  yNA_size = (ref1 = chartOpts != null ? chartOpts.yNA_size : void 0) != null ? ref1 : {
    width: 20,
    gap: 10 // width and gap for y=NA box
  };
  xlim = (ref2 = chartOpts != null ? chartOpts.xlim : void 0) != null ? ref2 : null; // x-axis limits
  ylim = (ref3 = chartOpts != null ? chartOpts.ylim : void 0) != null ? ref3 : null; // y-axis limits
  pointcolor = (ref4 = chartOpts != null ? chartOpts.pointcolor : void 0) != null ? ref4 : null; // fill color of points
  pointstroke = (ref5 = chartOpts != null ? chartOpts.pointstroke : void 0) != null ? ref5 : "black"; // color of points' outer circle
  ...
  chart = function chart(selection, data) {
    ...
    if (data.x == null) {
      d3panels.displayError("timeplot: data.x is missing");
    }
    if (data.y == null) {
      d3panels.displayError("timeplot: data.y is missing");
    }
    // missing values can be any of null, "NA", or ""; replacing with nulls
    x = d3panels.missing2null(data.x);
    y = d3panels.missing2null(data.y);
