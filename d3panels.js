...
d3panels.lod2dheatmap = function (chartOpts) {
  ...
  chart = function chart(selection, data) {
    ...
    var cellg, chr, i, indexWithinChr, j, k, l, len, len1, len2, m, myframe, n_pos, posByChr, ref12, ref13, ref14, tooltipfunc, x, xmid_scaled, y, ymid_scaled, zmax, zmin;
...
d3panels.heatmap = function (chartOpts) {
  ...
  chart = function chart(selection, data) {
    ...
    var cell, cellrect, i, j, myframe, nx, ny, ref10, ref9, tooltipfunc, xlabels, xmid, xmid_scaled, xv, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
...
d3panels.lodheatmap = function (chartOpts) {
  ...
  chart = function chart(selection, data) {
    ...
    var cellg, celltipfunc, chr, direction, i, j, k, l, len, len1, len2, len3, len4, lod, m, myframe, n, n_lod, n_pos, o, pos, ref15, ref16, ref17, ref18, ref19, x, xmid_scaled, y, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
...
d3panels.mapchart = function (chartOpts) {
  ...
  chart = function chart(selection, data) {
    ...
    var chr, chrscale, direction, extentByChr, i, j, k, l, len, len1, markerpos, markers, minpos, myframe, n_chr, n_pos, pos, ref11, ref12, these_index, these_pos, tipfunc, x, xlim, xticklab, xticks, ylim;
...
d3panels.trichart = function (chartOpts) {
  ...
  chart = function chart(selection, data) {
    // data = {p, indID, group}
    var d, first, flag_length_not_3, flag_out_of_range, flag_sum_not_1, frame, framefunc, g, gr, group, i, indID, indices, j, len, n, ngroup, p, p1, p2, p3, p4, plot_height, plot_width, ref17, ref18, second, sum, v, vertices, vv, xlim, xy, ylim;
...
d3panels.timeplot = function (chartOpts) {
  var chart, indtip, jitter, pointcolor, points, pointsize, pointstroke, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, svg, tipclass, xlim, xscale, yNA, yNA_size, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {}; // make sure it's defined
  }
