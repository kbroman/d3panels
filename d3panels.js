...
var abs, calc_2dchrcell_rect, calc_cell_rect, calc_chrcell_rect, calc_chrscales, calc_crosstab, calc_midpoints, ci_by_group, colSums, count_groups, d3panels, displayError, expand2vector, forceAsArray, formatAxis, log10, log2, matrixExtent, matrixMax, matrixMaxAbs, matrixMin, maxdiff, mean_by_group, median, missing2null, pad_vector, pullVarAsArray, reorgByChr, reorgLodData, rowSums, sd_by_group, selectGroupColors, sumArray, transpose, unique;
  ...
  chart = function(selection, data) {
    ...
    if (data.poslabel != null) {
      ...
      data.poslabel = (function() {
        ...
        results = [];
        for (i in data.chr) {
          results.push(data.chr[i] + "@" + (formatAxis(data.pos)(data.pos[i])));
        }
        return results;
      })();
    }
