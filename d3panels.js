...
d3panels.lod2dheatmap = function(chartOpts) {
  ...
  chart = function(selection, data) {
    var c, cellg, chr, i, indexWithinChr, j, k, l, len, len1, len2, len3, len4, m, myframe, n, n_pos, o, posByChr, ref12, ref13, ref14, ref15, ref16, these_pos, x, xmid_scaled, y, ymid_scaled, zmax, zmin;
...
d3panels.lodheatmap = function(chartOpts) {
  ...
  cellSelect = null;
  chart = function(selection, data) {
    var c, cellg, chr, i, j, k, l, len, len1, len2, len3, len4, len5, len6, lod, m, myframe, n, n_lod, n_pos, o, p, pos, q, ref15, ref16, ref17, ref18, ref19, ref20, ref21, these_pos, x, xmid_scaled, y, ylabels, ymid, ymid_scaled, yv, zmax, zmin;
    if (data.ycat != null) {
      data.y = (function() {
        var results;
        results = [];
