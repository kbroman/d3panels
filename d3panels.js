...
calc_cell_rect = function(cells, x, y) {
  var cell, i, k, len, results, xmid, xpad, ymid, ypad;
  ...
  xmid = (function() {
    var k, ref, results;
    results = [];
    for (i = k = 0, ref = xpad.length - 2; 0 <= ref ? k <= ref : k >= ref; i = 0 <= ref ? ++k : --k) {
      results.push((xpad[i] + xpad[i + 1]) / 2);
    }
    return results;
  })();
  ymid = (function() {
    var k, ref, results;
    results = [];
    for (i = k = 0, ref = ypad.length - 2; 0 <= ref ? k <= ref : k >= ref; i = 0 <= ref ? ++k : --k) {
      results.push((ypad[i] + ypad[i + 1]) / 2);
    }
    return results;
  })();
  results = [];
