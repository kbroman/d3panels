...
d3panels.dotchart = function(chartOpts) {
  ...
  svg = null;
  chart = function(selection, data) {
    var force, g, group, i, indID, j, jitter_width, myframe, ngroup, pointGroup, ref17, ref18, ref19, ref20, results, scaledPoints, ticked, u, x, xlim, xv, y;
    ...
    if (jitter === "random") {
      ...
      if (horizontal) {
        ...
        force = d3.forceSimulation(scaledPoints).force("y", d3.forceY(function(d) {
          return d.y;
        })).force("collide", d3.forceCollide(pointsize * 1.1)).on("tick", ticked);
      } else {
        d3.range(scaledPoints.length).map(function(i) {
...
d3panels.add_points = function(chartOpts) {
  ...
  pointGroup = null;
  chart = function(prevchart, data) {
    var force, g, group, i, indID, j, ngroup, ref5, ref6, ref7, results, scaledPoints, svg, ticked, ux, uy, x, xscale, xwid, y, yscale, ywid;
    if (data.x == null) {
...
d3panels.slider = function(chartOpts) {
  ...
  ticks_at_stops = (ref16 = chartOpts != null ? chartOpts.ticks_at_stops : void 0) != null ? ref16 : true;
  value = 0;
  stopindex = 0;
  slider_svg = null;
