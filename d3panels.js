...
lodchart = function(chartOpts) {
  ...
  svg = null;
  chart = function(selection, data) {
    var bigpointsize, c, chr, curves, hiddenpoints, i, j, k, l, len, len1, len2, lodcurve, markerpoints, myframe, ref7, ref8, ref9, these_pos;
    ...
    if ((data != null ? data.chrname : void 0) == null) {
