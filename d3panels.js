...
d3panels.calc_breaks = function(number, low, high) {
  ...
  if (low >= high) {
    ...
    if (low > high) {
      ref = [high, low], low = ref[0], high = ref[1];
    }
    if (low === high) {
      low -= 0.5;
      high += 0.5;
...
d3panels.calc_freq = function(values, breaks, return_counts) {
...
d3panels.add_curves = function(chartOpts) {
  ...
  pointGroup = null;
  chart = function(prevchart, data) {
    var curvefunc, dataByPoint, g, group, i, indID, j, k, l, lastpoint, len, m, n_ind, ngroup, ref5, ref6, ref7, ref8, results, svg, v, x, xscale, y, yscale;
    if (data.x == null) {
...
d3panels.add_points = function(chartOpts) {
  ...
  pointsize = (ref1 = chartOpts != null ? chartOpts.pointsize : void 0) != null ? ref1 : 3;
  pointstroke = (ref2 = chartOpts != null ? chartOpts.pointstroke : void 0) != null ? ref2 : "black";
...
d3panels.trichart = function(chartOpts) {
  ...
  chart = function(selection, data) {
    ...
    xscale = d3.scale.linear().domain(xlim).range([margin.left, margin.left + plot_width]);
    yscale = d3.scale.linear().domain(ylim).range([plot_height + margin.top, margin.top]);
    pscale = function(p) {
    ...
    framefunc = d3.svg.line().x(function(d) {
...
d3panels.histchart = function(chartOpts) {
  var chart, curves, indtip, linecolor, linecolorhilit, linewidth, linewidthhilit, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, rotate_ylab, svg, tipclass, xlab, xlim, xscale, ylab, ylim, yscale;
  if (chartOpts == null) {
    chartOpts = {};
  }
  xlim = (ref = chartOpts != null ? chartOpts.xlim : void 0) != null ? ref : null;
  ylim = (ref1 = chartOpts != null ? chartOpts.ylim : void 0) != null ? ref1 : null;
  xlab = (ref2 = chartOpts != null ? chartOpts.xlab : void 0) != null ? ref2 : "";
  ylab = (ref3 = chartOpts != null ? chartOpts.ylab : void 0) != null ? ref3 : "";
  rotate_ylab = (ref4 = chartOpts != null ? chartOpts.rotate_ylab : void 0) != null ? ref4 : null;
  linecolor = (ref5 = chartOpts != null ? chartOpts.linecolor : void 0) != null ? ref5 : null;
  linecolorhilit = (ref6 = chartOpts != null ? chartOpts.linecolorhilit : void 0) != null ? ref6 : null;
  linewidth = (ref7 = chartOpts != null ? chartOpts.linewidth : void 0) != null ? ref7 : 2;
  linewidthhilit = (ref8 = chartOpts != null ? chartOpts.linewidthhilit : void 0) != null ? ref8 : 2;
  ...
  svg = null;
  chart = function(selection, data) {
    var add_curves, breaks, brlim, d, f, freq, i, j, k, l, len, len1, maxn, maxpos, myframe, n_ind, p, path_data, path_x, path_y, pt, ref10, x, xv, xx;
    if (data.x == null) {
    ...
    freq = (function() {
      ...
      for (k = 0, len = x.length; k < len; k++) {
        xv = x[k];
        results.push(d3panels.calc_freq(xv, breaks));
      }
      return results;
    })();
    maxpos = [];
