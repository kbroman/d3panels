...
d3panels.trichart = function(chartOpts) {
  var boxcolor, boxwidth, chart, height, indtip, labelpos, labels, margin, pointcolor, points, pointsize, pointstroke, rectcolor, ref, ref1, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, svg, tipclass, title, titlepos, width, xscale, yscale;
  if (chartOpts == null) {
    chartOpts = {};
  }
  width = (ref = chartOpts != null ? chartOpts.width : void 0) != null ? ref : 800;
  ...
  svg = null;
  chart = function(selection, data) {
    var d, flag_length_not_3, flag_out_of_range, flag_sum_not_1, group, i, indID, j, k, len, len1, n, p, path, plot_height, plot_width, ref14, ref15, sum, v, val, vertices, xlim, xy, ylim;
    if (data.p == null) {
