...
d3panels.dotchart = function(chartOpts) {
  ...
  svg = null;
  chart = function(selection, data) {
    var force, g, group, i, indID, j, jitter_width, k, myframe, ngroup, pointGroup, ref17, ref18, ref19, ref20, results, results1, scaledPoints, u, x, xlim, xv, y;
...
d3panels.add_points = function(chartOpts) {
  ...
  pointGroup = null;
  chart = function(prevchart, data) {
    var force, g, group, i, indID, j, k, ngroup, ref5, ref6, ref7, results, results1, scaledPoints, svg, ux, uy, x, xscale, xwid, y, yscale, ywid;
    if (data.x == null) {
